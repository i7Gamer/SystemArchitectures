...
public class ClosingFilter extends DataTransformationFilter2<PlanarImage, PlanarImage> {
    private final float[] kernelMatrix;
    private final int amountOfErodesAndDilates;

    public ClosingFilter(Readable<PlanarImage> input, Writeable<PlanarImage> output, float[] kernelMatrix, int amountOfErodesAndDilates) throws InvalidParameterException {
        super(input, output);
        this.kernelMatrix = kernelMatrix;
        this.amountOfErodesAndDilates = amountOfErodesAndDilates;
    }

    public ClosingFilter(Readable<PlanarImage> input, float[] kernelMatrix, int amountOfErodesAndDilates) throws InvalidParameterException {
        super(input);
        this.kernelMatrix = kernelMatrix;
        this.amountOfErodesAndDilates = amountOfErodesAndDilates;
    }

    public ClosingFilter(Writeable<PlanarImage> output, float[] kernelMatrix, int amountOfErodesAndDilates) throws InvalidParameterException {
        super(output);
        this.kernelMatrix = kernelMatrix;
        this.amountOfErodesAndDilates = amountOfErodesAndDilates;
    }
