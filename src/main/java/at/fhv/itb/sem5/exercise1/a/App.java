...
public class App {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String textSinkFileName = "aufgabe1/aliceInWonderlandText.txt";
        String frequentEnglishWords = "aufgabe1/frequentEnglishWords.txt";

        HashSet<String> frequentWords = getFrequentWords(frequentEnglishWords);
        frequentWords = new HashSet<>();
