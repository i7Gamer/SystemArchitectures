...
public class App {
    ...
    private static String sourceFileName = "aufgabe1/aliceInWonderland.txt";
    private static String sinkFileName = "aufgabe1/aliceInWonderlandIndex.txt";
    private static String textSinkFileName = "aufgabe1/aliceInWonderlandText.txt";
    private static String frequentEnglishWords = "aufgabe1/frequentEnglishWords.txt";
